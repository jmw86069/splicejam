...
If data was imported at the transcript level (above) then it
...
* **{r format(numDetectedTx, scientific=FALSE, big.mark=",")} detected transcripts
* **{r format(numDetectedGenes, scientific=FALSE, big.mark=",")} detected genes
...
the plotly R package (ref). A helper function is available
from jampack called `bgaPlotly3d()`.
...
if (1 == 2 && suppressPackageStartupMessages(require(made4))) {
   ...
   htmlwidgets::saveWidget(geneBgaly,
      file="Adam19_BGA_clustering_21mar2019.html",
      title="Adam19 RNA-seq BGA clustering");
}
```
